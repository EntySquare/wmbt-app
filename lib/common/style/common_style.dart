...
class CommonStyle {
  ...
  static const TextStyle text_15_grey_w700 = TextStyle(
      color: Color.fromRGBO(23, 25, 48, 0.75), fontSize: 15, fontWeight: FontWeight.w700, fontFamily: 'FangZhengHeiTiFanTi');
  ...
  static final TextStyle text_12_grey_opacity40 = TextStyle(
      color: Color(0xFF171930).withOpacity(0.4), fontSize: 12, fontWeight: FontWeight.w400, fontFamily: 'FangZhengHeiTiFanTi');
  ...
  static final TextStyle text_12_grey_opacity60 = TextStyle(
      color: Color(0xFF171930).withOpacity(0.6), fontSize: 12, fontWeight: FontWeight.w400, fontFamily: 'FangZhengHeiTiFanTi');
  ...
  static final TextStyle text_24_black_opacity70 = TextStyle(
      color: Color(0x000000).withOpacity(0.6), fontSize: 24, fontWeight: FontWeight.w700, fontFamily: 'FangZhengHeiTiFanTi');
  ...
  static const TextStyle text_12_blue =
      TextStyle(color: Color(0xFF1C5AB8), fontSize: 12, fontWeight: FontWeight.w400, fontFamily: 'FangZhengHeiTiFanTi');
  static final TextStyle text_15_black_opacity60 = TextStyle(
      color: Color(0xFF171930).withOpacity(0.6), fontSize: 15, fontWeight: FontWeight.w400, fontFamily: 'FangZhengHeiTiFanTi');
  static final TextStyle text_15_black_opacity50 = TextStyle(
      color: Color(0xFF171930).withOpacity(0.5), fontSize: 15, fontWeight: FontWeight.w400, fontFamily: 'FangZhengHeiTiFanTi');
  ...
  static final TextStyle text_10_gray_opacity60 = TextStyle(
      color: Color(0x8000000).withOpacity(0.6), fontSize: 10, fontWeight: FontWeight.w400, fontFamily: 'FangZhengHeiTiFanTi');
  ...
  static final TextStyle text_12_black_opacity50 = TextStyle(
      color: Color(0xFF000000).withOpacity(0.5), fontSize: 12, fontFamily: 'FangZhengHeiTiFanTi');

  //
  static const TextStyle text_14_colorF6F6FB_w400 =
  TextStyle(color: Color(0xFFF6F6FB), fontSize: 14, fontWeight: FontWeight.w400, fontFamily: 'FangZhengHeiTiFanTi');

  static final TextStyle text_14_colorF6F6FB_w400_opacity50 = TextStyle(
      color: Color(0xffF6F6FB).withOpacity(0.5), fontSize: 14, fontWeight: FontWeight.w400, fontFamily: 'FangZhengHeiTiFanTi');
