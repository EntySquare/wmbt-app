...
class CommonStyle {
  ...
  static const TextStyle text_15_grey = TextStyle(
      color: Colors.grey,
      fontSize: 15,
  ...
  static const TextStyle text_15_grey_w700 = TextStyle(
      ...
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_15_black_w700 = TextStyle(
      color: Colors.black,
      fontSize: 15,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
  ...
  static const TextStyle text_12_black_w700 =
      TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w700, decoration: TextDecoration.none);

  static const TextStyle text_12_colorD9D9D9_w400 =
      TextStyle(color: Color(0xffD9D9D9), fontSize: 12, fontWeight: FontWeight.w400, decoration: TextDecoration.none);

  static final TextStyle text_12_colorF6F6FB_w400_opacity50 = TextStyle(
      color: Color(0xFFF6F6FB).withOpacity(0.5),
      fontSize: 12,
      fontWeight: FontWeight.w400,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  ...
  static const TextStyle text_12_blue = TextStyle(
      color: Color(0xFF1C5AB8),
      fontSize: 12,
      fontWeight: FontWeight.w400,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  ...
  static final TextStyle text_15_black_opacity50 = TextStyle(
      ...
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_34_black_w700 = TextStyle(
  ...
  static const TextStyle text_12_white = TextStyle(
  ...
  static const TextStyle text_12_white_w400 = TextStyle(
      color: Color(0xFFffffff),
      fontSize: 12,
      fontWeight: FontWeight.w400,
      fontFamily: 'FangZhengHeiTiFanTi',
  ...
  static const TextStyle text_14_white =
      TextStyle(color: Color(0xFFffffff), fontSize: 14, decoration: TextDecoration.none);

  static const TextStyle text_14_white_w600 =
      TextStyle(color: Color(0xFFffffff), fontSize: 14, fontWeight: FontWeight.w600, decoration: TextDecoration.none);

  static const TextStyle text_14_white_w400 =
      TextStyle(color: Color(0xFFffffff), fontSize: 14, fontWeight: FontWeight.w400, decoration: TextDecoration.none);
  ...
  static const TextStyle text_16_white_underline =
      TextStyle(color: Color(0xFFffffff), fontSize: 16, decoration: TextDecoration.underline);
  static const TextStyle text_16_white_w700 =
      TextStyle(color: Color(0xFFffffff), fontSize: 16, fontWeight: FontWeight.w700);
  static const TextStyle text_25_white =
      TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w700, decoration: TextDecoration.none);
  static const TextStyle text_18_w700 = TextStyle(
      color: Color(0xFFffffff),
      fontSize: 18,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_20_white_w700 = TextStyle(
      color: Color(0xFFffffff),
      fontSize: 20,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_20_black_w400 = TextStyle(
      color: Colors.black,
      fontSize: 20,
      fontWeight: FontWeight.w400,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_20_black_w600 = TextStyle(
      color: Colors.black,
      fontSize: 20,
      fontWeight: FontWeight.w600,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_18_blue_w700 = TextStyle(
      color: Color(0xFF1C5AB8),
      fontSize: 18,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_18_dark_green_w700 = TextStyle(
      color: Color(0xff378f78),
      fontSize: 18,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);

  static const TextStyle text_14_blue_w400 = TextStyle(
      color: Color(0xFF1C5AB8),
      fontSize: 14,
      fontWeight: FontWeight.w400,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_18_grey_w700 = TextStyle(
      color: Colors.grey,
      fontSize: 18,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
  ...
  static const TextStyle text_14_grey_w400_underline = TextStyle(
      ...
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.underline);
  static const TextStyle text_14_dark_green_w700 = TextStyle(
      color: Color(0xff378f78),
      fontSize: 14,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_14_grey_w700 = TextStyle(
      color: Colors.grey,
      fontSize: 14,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_18_black_w700 = TextStyle(
      color: Color(0xFF000000),
      fontSize: 18,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
      decoration: TextDecoration.none);
  static const TextStyle text_18_black_w400 = TextStyle(
      color: Color(0xFF000000),
      fontSize: 18,
      fontWeight: FontWeight.w400,
      fontFamily: 'FangZhengHeiTiFanTi',
  ...
  //
  static const TextStyle text_14_colorF6F6FB_w400 = TextStyle(
  ...
  static const TextStyle text_14_colorF6F6FB_w600 = TextStyle(
      color: Color(0xFFF6F6FB),
      fontSize: 14,
      fontWeight: FontWeight.w600,
      fontFamily: 'FangZhengHeiTiFanTi',
  ...
  static const TextStyle text_14_black_w400 = TextStyle(
      color: Color(0xFF000000),
      fontSize: 14,
      fontWeight: FontWeight.w400,
      fontFamily: 'FangZhengHeiTiFanTi',
  ...
  static const TextStyle text_14_black_w700 = TextStyle(
      color: Color(0xFF000000),
      fontSize: 14,
      fontWeight: FontWeight.w700,
      fontFamily: 'FangZhengHeiTiFanTi',
